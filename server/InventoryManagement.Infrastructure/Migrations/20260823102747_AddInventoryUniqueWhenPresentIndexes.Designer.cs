...
namespace InventoryManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260823102747_AddInventoryUniqueWhenPresentIndexes")]
    partial class AddInventoryUniqueWhenPresentIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.Inventory", b =>
                {
                    ...
                    b.HasIndex(new[] { "TenantId", "Barcode" }, "UX_Inventories_TenantId_Barcode")
                        .IsUnique()
                        .HasDatabaseName("UX_Inventories_TenantId_Barcode")
                        .HasFilter("\"Barcode\" IS NOT NULL AND \"Barcode\" <> '' AND \"IsDeleted\" = 0");

                    b.HasIndex(new[] { "TenantId", "SerialNumber" }, "UX_Inventories_TenantId_SerialNumber")
                        .IsUnique()
                        .HasDatabaseName("UX_Inventories_TenantId_SerialNumber")
                        .HasFilter("\"SerialNumber\" IS NOT NULL AND \"SerialNumber\" <> '' AND \"IsDeleted\" = 0");
